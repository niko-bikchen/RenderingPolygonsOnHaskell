module P18_SnubDodecahedron where
...
renderSnubDodecahedron = do
  ...
  let rogueTriangles = findPolygonsWithoutBase pentagonIndices triangleIndices
  let connectorTriangles = makeSimilarFaces rogueTriangles red
  renderShadowedPolyFaces connectorTriangles vertices
